...
(Compatibility shim — config moved to server/config.py)"""
from server.config import *
# Private globals (not imported by *)
from server.config import _SSE_QUEUE, _CHANNEL_FINGERPRINTS, _fp_lock, _CHANNEL_BURST
